    ...
    *,
    ...
    try:
        ...
        metadata = {
            ...
            "parser_contract": audit.get("contracts", {}).get("parser"),
            "canonical_representation_version": audit.get("contracts", {}).get("canonical_representation_version"),
            "canonicalizer_version": audit.get("contracts", {}).get("canonicalizer_version"),
            "source_transform_version": audit.get("contracts", {}).get("source_transform_version"),
