    ...
    *,
    ...
    try:
        ...
        audit = build_native_pre_mvp_db(
            ...
            dense_device=None if config.dense_device == "auto" else config.dense_device,
            sparse_device=None if config.sparse_device == "auto" else config.sparse_device,
            dense_torch_dtype=config.dense_dtype,
            sparse_torch_dtype=config.sparse_dtype,
